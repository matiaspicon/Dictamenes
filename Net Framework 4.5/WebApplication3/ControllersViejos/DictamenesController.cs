...
namespace WebApplication3.Controllers
{
    public class DictamenesController : Controller
    {
        ...
        public async Task<ActionResult> CargarFile(HttpPostedFileBase file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Create(Dictamen dictamen, SujetoObligado sujetoObligado)
        {
            ...
            {
                _context.Dictamenes.Add(dictamen);
                await _context.SaveChangesAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(int id, Dictamen dictamen)
        {
            if (id != dictamen.Id)
            {
                return HttpNotFound();
