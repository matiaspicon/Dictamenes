...
namespace WebApplication3.Controllers
{
    public class TiposSujetoObligadoController : Controller
    {
        ...
        public TiposSujetoObligadoController() { }
        ...
        public async Task<ActionResult> Create(  TipoSujetoObligado tipoSujetoObligado)
        {
            ...
            {
                _context.TipoSujetoObligado.Add(tipoSujetoObligado);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(int id,   TipoSujetoObligado tipoSujetoObligado)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    tipoSujetoObligado.FechaModificacion = DateTime.Now;
                    _context.Entry(tipoSujetoObligado).State = EntityState.Modified;
